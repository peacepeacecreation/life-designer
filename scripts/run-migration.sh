...
SQL_FILE="supabase/migrations/006_add_clockify_integration.sql"
...
if [ "$HTTP_CODE" = "201" ] || [ "$HTTP_CODE" = "200" ]; then
  ...
  echo ""
  echo "Clockify Integration tables created:"
  echo "  • clockify_connections - Store API keys and workspace info"
  echo "  • clockify_projects - Mirror Clockify projects"
  echo "  • clockify_project_goal_mappings - Link projects to goals"
  echo "  • time_entries - Track time entries from Clockify"
  echo "  • clockify_sync_logs - Monitor sync operations"
  echo ""
else
